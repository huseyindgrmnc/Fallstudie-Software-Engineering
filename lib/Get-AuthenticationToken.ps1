function Get-AuthenticationToken {
  ...
  $token = Get-AuthenticationToken -npsso "MPxOhrlnq56wymusxD7nHK3YM676bypmseB2wUbTpw5v1W3mNX0E6sT1Uayu5vQB"
  
  $outputFile = "C:\Users\hdegirmenci\AndroidStudioProjects\fallstudie1\assets\trophy_titles.json"
